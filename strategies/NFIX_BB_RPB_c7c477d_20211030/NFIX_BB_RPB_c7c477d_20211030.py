...
class NFIX_BB_RPB_c7c477d_20211030(IStrategy):
    ...
    def sell_long_mode(self, current_profit: float, max_profit:float, max_loss:float, last_candle, previous_candle_1, previous_candle_2, previous_candle_3, previous_candle_4, previous_candle_5, trade: 'Trade', current_time: 'datetime', enter_tag) -> tuple:
        ...
        sell, signal_name = self.exit_signals(current_profit, max_profit, max_loss, last_candle, previous_candle_1, previous_candle_2, previous_candle_3, previous_candle_4, previous_candle_5, trade, current_time, enter_tag)
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        # Long mode
        if all(c in ['31', '32', '33', '34'] for c in enter_tags):
        ...
        # Quick sell mode
        if all(c in ['empty', '38', '39'] for c in enter_tags):
